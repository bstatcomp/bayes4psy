...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(56, 54, "end", "model_success_rate");
    return reader;
}
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),1))) {
                ...
                lp_accum__.add(uniform_log<propto__>(p0, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),2))) {

                current_statement_begin__ = 28;
                lp_accum__.add(normal_log<propto__>(p0, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),3))) {

                current_statement_begin__ = 30;
                lp_accum__.add(gamma_log<propto__>(p0, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),4))) {

                current_statement_begin__ = 32;
                lp_accum__.add(beta_log<propto__>(p0, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            }
            ...
            if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),1))) {
                ...
                lp_accum__.add(uniform_log<propto__>(tau, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),2))) {

                current_statement_begin__ = 40;
                lp_accum__.add(normal_log<propto__>(tau, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),3))) {

                current_statement_begin__ = 42;
                lp_accum__.add(gamma_log<propto__>(tau, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            } else if (as_bool(logical_eq(get_base1(p_ids,id,"p_ids",1),4))) {

                current_statement_begin__ = 44;
                lp_accum__.add(beta_log<propto__>(tau, get_base1(p_values,((id * 2) - 1),"p_values",1), get_base1(p_values,(id * 2),"p_values",1)));
            }
