...
namespace model_subject_trials_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_subject_trials");
    reader.add_event(35, 35, "end", "model_subject_trials");
    return reader;
}

#include <meta_header.hpp>
 class model_subject_trials : public prob_grad {
private:
    int n;
    int m;
    matrix_d T;
    vector<vector<int> > S;
public:
    model_subject_trials(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_subject_trials_namespace::model_subject_trials";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  ss;
            ...
            Eigen::Matrix<T__,Eigen::Dynamic,1>  p;
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_subject_trials_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_subject_trials_namespace::model_subject_trials stan_model;
